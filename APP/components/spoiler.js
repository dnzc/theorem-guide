    ...
    return (
        <blockquote>
            <div className="absolute">
                <button onClick={show} className={`relative top-2 p-1 text-highlight-subtle border-2 border-highlight-subtle rounded-lg flex items-center space-x-0.5${visible ? ' hidden' : ''}`}>
