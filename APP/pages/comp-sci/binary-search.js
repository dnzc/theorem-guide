    ...
    <Sidebar>
        ...
        <div className="scrollshadow-vertical overflow-y-auto w-full md:w-[calc(270px-2px)] min-h-10 h-[30vh] md:h-[calc(60vh-8.5rem)] xl:hidden shrink-0 px-4 py-2 border-t-2 md:border-t-0 md:border-b-2 border-border-subtle">
            ...
            <ul>
                    ...
                    <li className="pt-1 font-bold"><Link href="#pseudocode" className="tocentry text-link [@media(hover:hover)]:hover:underline">Pseudocode</Link></li>
                
                    <li className="pt-1 font-bold"><Link href="#example-problem-minimum-excludant" className="tocentry text-link [@media(hover:hover)]:hover:underline">Example problem: Minimum excludant</Link></li>
                
                    <li className="pt-1 font-bold"><Link href="#harder-problem-ntarsis-set" className="tocentry text-link [@media(hover:hover)]:hover:underline">Harder problem: Ntarsis' Set</Link></li>
...
<pre><span></span><code><span className="p">[</span><span className="mi">1</span><span className="p">,</span>&nbsp;<span className="mi">2</span><span className="p">,</span>&nbsp;<span className="mi">5</span><span className="p">,</span>&nbsp;<span className="mi">7</span><span className="p">,</span>&nbsp;<span className="mi">8</span><span className="p">,</span>&nbsp;<span className="mi">9</span><span className="p">,</span>&nbsp;<span className="mi">10</span><span className="p">]</span><br/>&nbsp;<span className="o">^</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="o">^</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="o">^</span><br/><span className="n">left</span><span className="o">=</span><span className="mi">0</span>&nbsp;&nbsp;&nbsp;<span className="n">mid</span><span className="o">=</span><span className="mi">3</span>&nbsp;&nbsp;&nbsp;<span className="n">right</span><span className="o">=</span><span className="mi">6</span><br/></code></pre>
</div>
...
<div className="codehilite">
<pre><span></span><code><span className="p">[</span><span className="mi">1</span><span className="p">,</span>&nbsp;<span className="mi">2</span><span className="p">,</span>&nbsp;<span className="mi">5</span><span className="p">,</span>&nbsp;<span className="mi">7</span><span className="p">,</span>&nbsp;<span className="mi">8</span><span className="p">,</span>&nbsp;<span className="mi">9</span><span className="p">,</span>&nbsp;<span className="mi">10</span><span className="p">]</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="o">^</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="o">^</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">l</span><span className="o">=</span><span className="mi">4</span>&nbsp;&nbsp;&nbsp;<span className="n">r</span><span className="o">=</span><span className="mi">6</span><br/></code></pre>
</div>
...
<div className="codehilite">
<pre><span></span><code><span className="p">[</span><span className="mi">1</span><span className="p">,</span>&nbsp;<span className="mi">2</span><span className="p">,</span>&nbsp;<span className="mi">5</span><span className="p">,</span>&nbsp;<span className="mi">7</span><span className="p">,</span>&nbsp;<span className="mi">8</span><span className="p">,</span>&nbsp;<span className="mi">9</span><span className="p">,</span>&nbsp;<span className="mi">10</span><span className="p">]</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="o">^</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">l</span><span className="o">=</span><span className="n">r</span><span className="o">=</span><span className="mi">4</span><br/></code></pre>
</div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="pseudocode" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Pseudocode</h2><Link href="#pseudocode" onClick={() => copyToClipboard("https://notes.danielc.rocks/comp-sci/binary-search#pseudocode", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="example-problem-minimum-excludant" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Example problem: Minimum excludant</h2><Link href="#example-problem-minimum-excludant" onClick={() => copyToClipboard("https://notes.danielc.rocks/comp-sci/binary-search#example-problem-minimum-excludant", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<ul>
<li><p>Considering the smallest missing element from the array, we must have that the items before it are the positive integers in order, with no gaps.</p></li>
<li><p>So the smallest missing element is the smallest element whose value is not equal to its index (indexing from 1). We can use binary search to find this.</p></li>
</ul>

<div className="codehilite relative">
<div className="absolute top-2 right-2"><CopyButton text="#!/usr/bin/python3\n\ndef solve(array):\n    l = 0\n    r = len(array)\n    while l != r:\n        m = (l+r) // 2\n        if array[m] != m+1:\n            r = m\n        else:\n            l = m+1\n    return l+1"/></div>
<pre><span></span><code><span className="ch">#!/usr/bin/python3</span><br/><br/><span className="k">def</span><span className="w">&nbsp;</span><span className="nf">solve</span><span className="p">(</span><span className="n">array</span><span className="p">):</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">l</span>&nbsp;<span className="o">=</span>&nbsp;<span className="mi">0</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">r</span>&nbsp;<span className="o">=</span>&nbsp;<span className="nb">len</span><span className="p">(</span><span className="n">array</span><span className="p">)</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span className="k">while</span>&nbsp;<span className="n">l</span>&nbsp;<span className="o">!=</span>&nbsp;<span className="n">r</span><span className="p">:</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">m</span>&nbsp;<span className="o">=</span>&nbsp;<span className="p">(</span><span className="n">l</span><span className="o">+</span><span className="n">r</span><span className="p">)</span>&nbsp;<span className="o">//</span>&nbsp;<span className="mi">2</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="k">if</span>&nbsp;<span className="n">array</span><span className="p">[</span><span className="n">m</span><span className="p">]</span>&nbsp;<span className="o">!=</span>&nbsp;<span className="n">m</span><span className="o">+</span><span className="mi">1</span><span className="p">:</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">r</span>&nbsp;<span className="o">=</span>&nbsp;<span className="n">m</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="k">else</span><span className="p">:</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">l</span>&nbsp;<span className="o">=</span>&nbsp;<span className="n">m</span><span className="o">+</span><span className="mi">1</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span className="k">return</span>&nbsp;<span className="n">l</span><span className="o">+</span><span className="mi">1</span><br/></code></pre>
</div>

</Spoiler>

<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="harder-problem-ntarsis-set" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Harder problem: Ntarsis' Set</h2><Link href="#harder-problem-ntarsis-set" onClick={() => copyToClipboard("https://notes.danielc.rocks/comp-sci/binary-search#harder-problem-ntarsis-set", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<pre><span></span><code><span className="cp">#include</span><span className="w">&nbsp;</span><span className="cpf">&lt;bits/stdc++.h&gt;</span><br/><br/><span className="cp">#define&nbsp;ll&nbsp;long&nbsp;long</span><br/><br/><span className="k">using</span><span className="w">&nbsp;</span><span className="k">namespace</span><span className="w">&nbsp;</span><span className="nn">std</span><span className="p">;</span><br/><br/><span className="kt">int</span><span className="w">&nbsp;</span><span className="n">n</span><span className="p">,</span><span className="w">&nbsp;</span><span className="n">k</span><span className="p">,</span><span className="w">&nbsp;</span><span className="n">a</span><span className="p">[</span><span className="mi">200010</span><span className="p">];</span><br/><br/><span className="kt">void</span><span className="w">&nbsp;</span><span className="nf">solve</span><span className="p">()</span><span className="w">&nbsp;</span><span className="p">&#123;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">cin</span><span className="w">&nbsp;</span><span className="o">&gt;&gt;</span><span className="w">&nbsp;</span><span className="n">n</span><span className="w">&nbsp;</span><span className="o">&gt;&gt;</span><span className="w">&nbsp;</span><span className="n">k</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="k">for</span><span className="p">(</span><span className="kt">int</span><span className="w">&nbsp;</span><span className="n">i</span><span className="o">=</span><span className="mi">0</span><span className="p">;</span><span className="w">&nbsp;</span><span className="n">i</span><span className="o">&lt;</span><span className="n">n</span><span className="p">;</span><span className="w">&nbsp;</span><span className="o">++</span><span className="n">i</span><span className="p">)</span><span className="w">&nbsp;</span><span className="p">&#123;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">cin</span><span className="w">&nbsp;</span><span className="o">&gt;&gt;</span><span className="w">&nbsp;</span><span className="n">a</span><span className="p">[</span><span className="n">i</span><span className="p">];</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">a</span><span className="p">[</span><span className="n">i</span><span className="p">]</span><span className="w">&nbsp;</span><span className="o">-=</span><span className="w">&nbsp;</span><span className="n">i</span><span className="o">+</span><span className="mi">1</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="p">&#125;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="k">if</span><span className="p">(</span><span className="n">a</span><span className="p">[</span><span className="mi">0</span><span className="p">]</span><span className="w">&nbsp;</span><span className="o">!=</span><span className="w">&nbsp;</span><span className="mi">0</span><span className="p">)</span><span className="w">&nbsp;</span><span className="p">&#123;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">cout</span><span className="w">&nbsp;</span><span className="o">&lt;&lt;</span><span className="w">&nbsp;</span><span className="s">&quot;1</span><span className="se">\n</span><span className="s">&quot;</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="k">return</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="p">&#125;</span><br/><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">ll</span><span className="w">&nbsp;</span><span className="n">x</span><span className="w">&nbsp;</span><span className="o">=</span><span className="w">&nbsp;</span><span className="mi">0</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="k">for</span><span className="p">(</span><span className="kt">int</span><span className="w">&nbsp;</span><span className="n">i</span><span className="o">=</span><span className="mi">0</span><span className="p">;</span><span className="w">&nbsp;</span><span className="n">i</span><span className="o">&lt;</span><span className="n">k</span><span className="p">;</span><span className="w">&nbsp;</span><span className="o">++</span><span className="n">i</span><span className="p">)</span><span className="w">&nbsp;</span><span className="p">&#123;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="kt">int</span><span className="w">&nbsp;</span><span className="n">l</span><span className="o">=</span><span className="mi">0</span><span className="p">,</span><span className="w">&nbsp;</span><span className="n">r</span><span className="o">=</span><span className="n">n</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="kt">int</span><span className="w">&nbsp;</span><span className="n">m</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="k">while</span><span className="p">(</span><span className="n">r</span><span className="o">-</span><span className="n">l</span><span className="o">&gt;</span><span className="mi">1</span><span className="p">)</span><span className="w">&nbsp;</span><span className="p">&#123;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">m</span><span className="w">&nbsp;</span><span className="o">=</span><span className="w">&nbsp;</span><span className="p">(</span><span className="n">l</span><span className="o">+</span><span className="n">r</span><span className="p">)</span><span className="o">/</span><span className="mi">2</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="k">if</span><span className="p">(</span><span className="n">a</span><span className="p">[</span><span className="n">m</span><span className="p">]</span><span className="w">&nbsp;</span><span className="o">&gt;</span><span className="w">&nbsp;</span><span className="n">x</span><span className="p">)</span><span className="w">&nbsp;</span><span className="n">r</span><span className="o">=</span><span className="n">m</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="k">else</span><span className="w">&nbsp;</span><span className="n">l</span><span className="o">=</span><span className="n">m</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="p">&#125;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">x</span><span className="w">&nbsp;</span><span className="o">+=</span><span className="w">&nbsp;</span><span className="p">(</span><span className="n">ll</span><span className="p">)(</span><span className="n">l</span><span className="o">+</span><span className="mi">1</span><span className="p">);</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="p">&#125;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">cout</span><span className="w">&nbsp;</span><span className="o">&lt;&lt;</span><span className="w">&nbsp;</span><span className="n">x</span><span className="o">+</span><span className="mi">1</span><span className="w">&nbsp;</span><span className="o">&lt;&lt;</span><span className="w">&nbsp;</span><span className="sc">&#39;\n&#39;</span><span className="p">;</span><br/><span className="p">&#125;</span><br/><br/><span className="kt">int</span><span className="w">&nbsp;</span><span className="nf">main</span><span className="p">()</span><span className="w">&nbsp;</span><span className="p">&#123;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">ios</span><span className="o">::</span><span className="n">sync_with_stdio</span><span className="p">(</span><span className="mi">0</span><span className="p">);</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="n">cin</span><span className="p">.</span><span className="n">tie</span><span className="p">(</span><span className="k">nullptr</span><span className="p">);</span><br/><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="kt">int</span><span className="w">&nbsp;</span><span className="n">t</span><span className="p">;</span><span className="w">&nbsp;</span><span className="n">cin</span><span className="w">&nbsp;</span><span className="o">&gt;&gt;</span><span className="w">&nbsp;</span><span className="n">t</span><span className="p">;</span><br/><span className="w">&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="k">while</span><span className="p">(</span><span className="n">t</span><span className="o">--</span><span className="p">)</span><span className="w">&nbsp;</span><span className="n">solve</span><span className="p">();</span><br/><span className="p">&#125;</span><br/></code></pre>
</div>
