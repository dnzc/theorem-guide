...
<pre><span></span><code><span className="ch">#!/usr/bin/python3</span><br/><br/><span className="k">def</span>&nbsp;<span className="nf">solve</span><span className="p">(</span><span className="n">array</span><span className="p">):</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">l</span>&nbsp;<span className="o">=</span>&nbsp;<span className="mi">0</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">r</span>&nbsp;<span className="o">=</span>&nbsp;<span className="nb">len</span><span className="p">(</span><span className="n">array</span><span className="p">)</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span className="k">while</span>&nbsp;<span className="n">l</span>&nbsp;<span className="o">!=</span>&nbsp;<span className="n">r</span><span className="p">:</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">m</span>&nbsp;<span className="o">=</span>&nbsp;<span className="p">(</span><span className="n">l</span><span className="o">+</span><span className="n">r</span><span className="p">)</span>&nbsp;<span className="o">//</span>&nbsp;<span className="mi">2</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="k">if</span>&nbsp;<span className="n">array</span><span className="p">[</span><span className="n">m</span><span className="p">]</span>&nbsp;<span className="o">!=</span>&nbsp;<span className="n">m</span><span className="o">+</span><span className="mi">1</span><span className="p">:</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">r</span>&nbsp;<span className="o">=</span>&nbsp;<span className="n">m</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="k">else</span><span className="p">:</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="n">l</span>&nbsp;<span className="o">=</span>&nbsp;<span className="n">m</span><span className="o">+</span><span className="mi">1</span><br/>&nbsp;&nbsp;&nbsp;&nbsp;<span className="k">return</span>&nbsp;<span className="n">l</span><span className="o">+</span><span className="mi">1</span><br/></code></pre>
</div>
