        ...
        <div className="border-elevated overflow-y-auto w-full md:w-[calc(300px-2px)] h-full md:h-auto md:max-h-[calc(100vh-15rem)] break-all">
            <div className="relative bottom-0 pl-4">
                <ul className="dirtree mb-4 md:mb-0">
                            ...
                            <Accordion title="4-euclid" href="/maths/proving-FTA/4-euclid" type="file" isRoot={false} isSelected={ true } />
...
<h2 id="what-its-argh" className="group flex">What? It's... argh!&nbsp;<Link href="#what-its-argh" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/4-euclid#what-its-argh", true)} className="hidden group-hover:block text-primary">¶</Link></h2>
...
<h2 id="the-actual-euclids-lemma" className="group flex">The actual Euclid's Lemma&nbsp;<Link href="#the-actual-euclids-lemma" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/4-euclid#the-actual-euclids-lemma", true)} className="hidden group-hover:block text-primary">¶</Link></h2>
        ...
        <nav className="hidden xl:flex w-[300px] xl:shrink-0 xl:justify-start h-100% min-h-screen border-l-2 border-elevated px-6 py-4">
            <div className="fixed">
                ...
                <ul className="text-elevated">
                        ...
                        <li className="pt-2 text-lg font-bold flex items-start justify-start space-x-1"><FaChevronRight className="relative top-2" size={12}/><Link href="#what-its-argh" className="text-link [@media(hover:hover)]:hover:underline">What? It's... argh!</Link></li>
