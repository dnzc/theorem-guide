...
export default function Euclid () {
    return (
        <Layout>
            <Head>
                <title>4 Euclid | Tripos Guru</title>
            </Head>
                <>
                    <ToastContainer
                        position='top-right'
    ...
    <Sidebar>
        ...
        <div className="scrollshadow-vertical overflow-y-auto w-full md:w-[calc(270px-2px)] min-h-10 h-[30vh] md:h-[calc(60vh-8.5rem)] xl:hidden shrink-0 px-4 py-2 border-t-2 md:border-t-0 md:border-b-2 border-border-subtle">
            ...
            <ul>
                    ...
                    <li className="pt-1 font-bold"><Link href="#what-its-argh" className="tocentry text-link [@media(hover:hover)]:hover:underline">What? It's... argh!</Link></li>
                
                    <li className="pt-1 font-bold"><Link href="#the-actual-euclids-lemma" className="tocentry text-link [@media(hover:hover)]:hover:underline">The actual Euclid's Lemma</Link></li>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="what-its-argh" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">What? It's... argh!</h2><Link href="#what-its-argh" onClick={() => copyToClipboard("https://tripos.guru/maths/proving-FTA/4-euclid#what-its-argh", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
...
<span className="scrollshadow-horizontal latex-display-wrapper"><Latex>$$x = (3-2)x = 3x-2x$$</Latex></span>
...
<blockquote>
  ...
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$x = (11 \cdot 51 - 20 \cdot 28)x$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 51 \cdot (11x) + 28x \cdot (-20)$$</Latex></span></p>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="the-actual-euclids-lemma" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">The actual Euclid's Lemma</h2><Link href="#the-actual-euclids-lemma" onClick={() => copyToClipboard("https://tripos.guru/maths/proving-FTA/4-euclid#the-actual-euclids-lemma", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
