...
export default function DivisionAlgo () {
    ...
    <Sidebar>
        ...
        <div className="scrollshadow-vertical overflow-y-auto w-full md:w-[calc(270px-2px)] min-h-10 h-[40vh] md:h-[40vh] xl:h-[calc(100vh-8.5rem)] break-all bg-background pt-3 md:pt-0 md:border-y-2 border-border-subtle">
                <ul className="scrollshadow-vertical dirtree mb-4 md:mb-0 group">
                            ...
                            <Accordion title="2-division-algo" href="/maths/proving-FTA/2-division-algo" type="file" relDepth={ 3 } isSelected={ true } />
    ...
    <article className="w-full min-w-0 px-6 pt-3 mb-14">
        ...
        <div className="flex flex-wrap items-center space-x-2 mb-3">
            ...
            <p className="text-text-secondary mb-2">Created 25 Jul 2023</p>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="back-to-school" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Back to School</h2><Link href="#back-to-school" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/2-division-algo#back-to-school", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
