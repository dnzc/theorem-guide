...
export default function BezoutEgcd () {
    ...
    <Sidebar>
        ...
        <div className="scrollshadow-vertical overflow-y-auto w-full md:w-[calc(270px-2px)] min-h-10 h-[30vh] md:h-[calc(60vh-8.5rem)] xl:hidden shrink-0 px-4 py-2 border-t-2 md:border-t-0 md:border-b-2 border-border-subtle">
            ...
            <ul>
                    ...
                    <li className="pt-1 font-bold"><Link href="#puzzle-water-jug-problem" className="tocentry text-link [@media(hover:hover)]:hover:underline">Puzzle: water-jug problem</Link></li>
                
                    <li className="pt-1 font-bold"><Link href="#numerical-evidence" className="tocentry text-link [@media(hover:hover)]:hover:underline">Numerical Evidence</Link></li>
                
                    <li className="pt-1 font-bold"><Link href="#bezouts-lemma-proof" className="tocentry text-link [@media(hover:hover)]:hover:underline">Bezout's Lemma: Proof</Link></li>
                
                    <li className="pt-1 font-bold"><Link href="#magic-box" className="tocentry text-link [@media(hover:hover)]:hover:underline">Magic box</Link></li>
                
                    <li className="pt-1 font-bold"><Link href="#remarks-first-unobvious-result" className="tocentry text-link [@media(hover:hover)]:hover:underline">Remarks: first unobvious result?</Link></li>
    ...
    <article className="w-full min-w-0 px-6 pt-3 mb-14">
        ...
        <div className="flex flex-wrap items-center space-x-2 mb-3">
                ...
                <Badge color="blue">numerical</Badge>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="puzzle-water-jug-problem" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Puzzle: water-jug problem</h2><Link href="#puzzle-water-jug-problem" onClick={() => copyToClipboard("https://tripos.guru/maths/proving-FTA/3-bezout-egcd#puzzle-water-jug-problem", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="numerical-evidence" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Numerical Evidence</h2><Link href="#numerical-evidence" onClick={() => copyToClipboard("https://tripos.guru/maths/proving-FTA/3-bezout-egcd#numerical-evidence", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
...
<blockquote>
  <p><span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$1 = 1\cdot 1 + 2\cdot 0$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = (3-2)\cdot 1 + 2\cdot 0$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 3\cdot 1 + 2\cdot (0-1)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 3\cdot 1 + (5-3)\cdot (-1)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 3\cdot (1+1) + 5\cdot (-1)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = (8-5)\cdot 2 + 5\cdot (-1)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 8\cdot 2 + 5\cdot (-1-2)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 8\cdot 2 - 5\cdot 3$$</Latex></span></p>
</blockquote>
...
<blockquote>
  <p><span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$1 = 1\cdot 1 + 6\cdot 0$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = (7-6)\cdot 1 + 6\cdot 0$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 7\cdot 1 + 6\cdot (0-1)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 7\cdot 1 + (20-2\cdot 7)\cdot (-1)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 7\cdot (1+2\cdot 1) + 20\cdot (-1)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = (27-20)\cdot 3 + 20\cdot (-1)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 27\cdot 3 + 20\cdot (-1-3)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 27\cdot 3 + (155-5\cdot 27)\cdot (-4)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 27\cdot (3+5\cdot 4) + (155\cdot (-4)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 27\cdot 23 - 155\cdot 4$$</Latex></span></p>
</blockquote>
...
<blockquote>
  ...
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$443 = 259 \cdot 1 + 184 \text&#123;, new pair is (259,184)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$259 = 184 \cdot 1 + 75 \text&#123;, new pair is (184,75)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$184 = 75 \cdot 2 + 34 \text&#123;, new pair is (75,34)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$75 = 34 \cdot 2 + 7 \text&#123;, new pair is (34,7)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$34 = 7 \cdot 4 + 6 \text&#123;, new pair is (7,6)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$7 = 6 \cdot 1 + 1 \text&#123;, new pair is (6,1)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$6 = 1 \cdot 6 + 0 \text&#123;, new pair is (1,0)&#125;$$</Latex></span>
  ...
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$1 = 1\cdot 1 - 0 \cdot 0$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 1\cdot 1 - (6 - 1\cdot 6) \cdot 0 \text&#123; (see last line of the division list)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 1\cdot (1+6\cdot 0) - 6 \cdot 0$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = (7-6 \cdot 1)\cdot 1 - 6 \cdot 0 \text&#123; (see penultimate line)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 7\cdot 1 - 6 \cdot (0+1\cdot 1)$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 7\cdot 1 - (34 - 7 \cdot 4) \cdot 1 \text&#123; (see... etc)&#125;$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 7\cdot (1+4\cdot 1) - 34 \cdot 1$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = (75 - 34\cdot 2)\cdot 5 - 34 \cdot 1$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 75\cdot 5 - 34 \cdot (1+2\cdot 5)$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 75\cdot 5 - (184 - 75 \cdot 2) \cdot 11$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 75\cdot (5 + 2\cdot 11) - 184 \cdot 11$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = (259-184\cdot 1)\cdot 27 - 184 \cdot 11$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 259\cdot 27 - 184 \cdot (11 + 1\cdot 27)$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 259\cdot 27 - (443 - 259 \cdot 1) \cdot 38$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 259\cdot (27 + 1\cdot 38) - 443 \cdot 38$$</Latex></span>
  
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = 259\cdot 65 - 443 \cdot 38$$</Latex></span>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="bezouts-lemma-proof" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Bezout's Lemma: Proof</h2><Link href="#bezouts-lemma-proof" onClick={() => copyToClipboard("https://tripos.guru/maths/proving-FTA/3-bezout-egcd#bezouts-lemma-proof", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
...
<span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$S = \&#123;n \in \mathbb&#123;N&#125; \mid n = ax + by,\; x,y \in \mathbb&#123;Z&#125;\&#125;$$</Latex></span>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="magic-box" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Magic box</h2><Link href="#magic-box" onClick={() => copyToClipboard("https://tripos.guru/maths/proving-FTA/3-bezout-egcd#magic-box", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
...
<blockquote>
  <p><span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$29x + 11y = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$(2\cdot 11 + 7)x + 11y = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$7x + 11(2x+y) = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$7x + (7\cdot 1+4)(2x+y) = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$7(3x+y) + 4(2x+y) = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$(4+3)(3x+y) + 4(2x+y) = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$3(3x+y) + 4(5x+2y) = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$3(3x+y) + (3+1)(5x+2y) = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$3(8x+3y) + 1(5x+2y) = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$(3\cdot 1 + 0)(8x+3y) + 1(5x+2y) = 1$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$0(8x+3y) + 1(29x + 11y) = 1$$</Latex></span></p>
</blockquote>
...
<span className="scrollshadow-horizontal latex-display-wrapper"><Latex>$$m(ax + by) + n(cx + dy)$$</Latex></span>

<span className="scrollshadow-horizontal latex-display-wrapper"><Latex>$$ = (qn+m')(ax + by) + n(cx + dy)$$</Latex></span>

<span className="scrollshadow-horizontal latex-display-wrapper"><Latex>$$ = m'(ax + by) + n(q(ax+by)+(cx + dy))$$</Latex></span>

<span className="scrollshadow-horizontal latex-display-wrapper"><Latex>$$ = m'(ax + by) + n((qa+c)x+(qb+d)y)$$</Latex></span>
  ...
  <table>
      <tbody>
          ...
          <tr>
              ...
              <td><Latex>$2$</Latex></td>
              <td><Latex>$3$</Latex></td>
              <td><em><Latex>$1\cdot 3 + 2 = 5$</Latex></em></td>
              <td></td>
              <td></td>
          </tr>
          <tr>
              ...
              <td><Latex>$1$</Latex></td>
              <td><Latex>$1$</Latex></td>
              <td><em><Latex>$1 \cdot 1 + 1 = 2$</Latex></em></td>
              <td></td>
              <td></td>
          </tr>
      </tbody>
...
<blockquote>
  ...
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$M_&#123;i+1&#125; = \begin&#123;pmatrix&#125; p_&#123;i+1&#125; &amp; t_i p_&#123;i+1&#125; + p_i \\ q_&#123;i+1&#125; &amp; t_i q_&#123;i+1&#125; + q_i\end&#123;pmatrix&#125;$$</Latex></span>
  Now we can write this in terms of <Latex>$M_i$</Latex> like so:
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$M_&#123;i+1&#125; = \begin&#123;pmatrix&#125; p_&#123;i+1&#125; &amp;  p_i \\ q_&#123;i+1&#125; &amp; q_i\end&#123;pmatrix&#125; + \begin&#123;pmatrix&#125; 0 &amp; t_i p_&#123;i+1&#125; \\ 0 &amp; t_i q_&#123;i+1&#125;\end&#123;pmatrix&#125;$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$= M_i \begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; 0 \end&#123;pmatrix&#125; + M_i\begin&#123;pmatrix&#125; 0 &amp; 0 \\ 0 &amp; t_i \end&#123;pmatrix&#125;$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$= M_i \begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; t_i \end&#123;pmatrix&#125;$$</Latex></span></p>
  ...
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$\begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; 0\end&#123;pmatrix&#125; \begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; t_1\end&#123;pmatrix&#125; \begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; t_2\end&#123;pmatrix&#125; (\cdots) \begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; t_n\end&#123;pmatrix&#125;$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = \prod_&#123;0 \leq i \leq n&#125; \begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; t_i\end&#123;pmatrix&#125;$$</Latex></span>
  ...
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$det(M_&#123;i+1&#125;)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$= det\left(M_i \begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; t_i \end&#123;pmatrix&#125;\right)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$= det(M_i) \, det\left(\begin&#123;pmatrix&#125; 0 &amp; 1 \\ 1 &amp; t_i \end&#123;pmatrix&#125;\right)$$</Latex></span>
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$ = -det(M_i)$$</Latex></span></p>
</blockquote>

<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="remarks-first-unobvious-result" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Remarks: first unobvious result?</h2><Link href="#remarks-first-unobvious-result" onClick={() => copyToClipboard("https://tripos.guru/maths/proving-FTA/3-bezout-egcd#remarks-first-unobvious-result", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
