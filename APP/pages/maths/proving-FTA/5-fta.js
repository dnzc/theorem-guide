...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="existence-of-a-prime-factorization" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Existence of a prime factorization</h2><Link href="#existence-of-a-prime-factorization" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/5-fta#existence-of-a-prime-factorization", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
