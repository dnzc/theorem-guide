...
<p><div className="overflow-auto latex-display-wrapper"><Latex>$$\forall a,b \in \mathbb&#123;Z&#125;, \; a \cdot b = b \cdot a, \; a+b=b+a$$</Latex></div></p>

<ul>
<li><strong>Associativity</strong>: in repeated addition or multiplication, the brackets do not matter. In symbols:</li>
</ul>

<p><div className="overflow-auto latex-display-wrapper"><Latex>$$\forall a,b,c \in \mathbb&#123;Z&#125;, \; (a \cdot b) \cdot c = a \cdot (b \cdot c),$$</Latex></div></p>

<p><div className="overflow-auto latex-display-wrapper"><Latex>$$(a+b)+c = a+(b+c)$$</Latex></div></p>

<ul>
<li><strong>Distributivity</strong>: multiplication is distributive over addition. In symbols:</li>
</ul>

<p><div className="overflow-auto latex-display-wrapper"><Latex>$$\forall a,b,c \in \mathbb&#123;Z&#125;, \; a\cdot(b+c) = a\cdot b + a \cdot c$$</Latex></div></p>
...
<p><div className="overflow-auto latex-display-wrapper"><Latex>$$\exists \, 0 \in \mathbb&#123;Z&#125; \; s.t. \; \forall a \in \mathbb&#123;Z&#125;, a+0=a$$</Latex></div></p>
...
<p><div className="overflow-auto latex-display-wrapper"><Latex>$$\forall a \in \mathbb&#123;Z&#125;, \exists \, a' \in \mathbb&#123;Z&#125; \; s.t.\;  a + a' = 0$$</Latex></div></p>
...
<p><div className="overflow-auto latex-display-wrapper"><Latex>$$\exists \, 1 \in \mathbb&#123;Z&#125; \; s.t. \; \forall a \in \mathbb&#123;Z&#125;, a\cdot 1=a$$</Latex></div></p>
...
<p>Use <strong>Lemma 7</strong> and <strong>Lemma 1</strong>: <div className="overflow-auto latex-display-wrapper"><Latex>$$-(a-b) \\= (-1) \cdot (a-b) \\= (-1) \cdot a + (-1) \cdot (-b) \\= -a + -(-b) \\= -a + b \\= b-a$$</Latex></div></p>
