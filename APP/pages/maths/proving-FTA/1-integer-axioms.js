...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="axioms-as-properties" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Axioms as Properties</h2><Link href="#axioms-as-properties" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/1-integer-axioms#axioms-as-properties", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="how-deep-do-we-go" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">How deep do we go?</h2><Link href="#how-deep-do-we-go" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/1-integer-axioms#how-deep-do-we-go", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="basic-properties" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Basic properties</h2><Link href="#basic-properties" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/1-integer-axioms#basic-properties", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="ordering-of-z" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Ordering of Z</h2><Link href="#ordering-of-z" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/1-integer-axioms#ordering-of-z", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="definitions" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Definitions</h2><Link href="#definitions" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/1-integer-axioms#definitions", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="structuring-logic-building-lemmas" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Structuring logic, building lemmas</h2><Link href="#structuring-logic-building-lemmas" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/1-integer-axioms#structuring-logic-building-lemmas", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2"><h2 id="lemma-list" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Lemma List</h2><Link href="#lemma-list" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/proving-FTA/1-integer-axioms#lemma-list", true)} className="hidden relative bottom-0.5 group-hover:block text-linkanchor">¶</Link></div>
