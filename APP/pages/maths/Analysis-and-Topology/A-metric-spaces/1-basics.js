...
export default function Basics () {
    return (
        <>
            <Head>
                <title>1 Basics | Tripos Guru</title>
            </Head>
                <>
                    <ToastContainer
                        position='top-right'
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="11-definitions-and-examples" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">1.1 Definitions and Examples</h2><Link href="#11-definitions-and-examples" onClick={() => copyToClipboard("https://tripos.guru/maths/Analysis-and-Topology/A-metric-spaces/1-basics#11-definitions-and-examples", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
