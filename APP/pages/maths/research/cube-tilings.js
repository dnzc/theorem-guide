...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="getting-a-foothold" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Getting a foothold</h2><Link href="#getting-a-foothold" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/research/cube-tilings#getting-a-foothold", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="construction-tools" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Construction Tools</h2><Link href="#construction-tools" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/research/cube-tilings#construction-tools", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="reducing-the-bound-with-code" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Reducing the bound with code</h2><Link href="#reducing-the-bound-with-code" onClick={() => copyToClipboard("https://notes.danielc.rocks/maths/research/cube-tilings#reducing-the-bound-with-code", true)} className="hidden group-hover:block text-linkanchor"><ImPilcrow size={20}/></Link></div>
