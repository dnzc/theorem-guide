...
export default function Search({ active }) {
    ...
    return (
        <div className='w-full h-full'>
            <input ref={inputRef} type='text' name='search' onChange={searchChange} onKeyDown={handleKeyDown} placeholder='Search…' className='bg-body rounded-t-lg w-full px-4 py-4 text-lg outline-none border-b-2 border-elevated'/>
