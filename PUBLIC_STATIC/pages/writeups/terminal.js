...
export default function Terminal () {
    ...
    <article className="w-full min-w-0 max-w-6xl px-6 pt-3">
            ...
            <p className="text-elevated mb-3">Last modified on 08 Jun 2024</p>
        ...
        <nav className="hidden xl:flex w-[300px] xl:shrink-0 xl:justify-start h-100% min-h-screen border-l-2 border-elevated px-6 py-4">
            <div className="fixed">
                ...
                <ul className="text-elevated">
                        ...
                        <li className="pt-2 text-lg font-bold flex items-center justify-start space-x-1"><FaChevronRight size={12}/><Link href="#hint-1" className="text-link">Hint 1</Link></li>
                    
                        <li className="pt-2 text-lg font-bold flex items-center justify-start space-x-1"><FaChevronRight size={12}/><Link href="#hint-2" className="text-link">Hint 2</Link></li>
                    
                        <li className="pt-2 text-lg font-bold flex items-center justify-start space-x-1"><FaChevronRight size={12}/><Link href="#hint-3" className="text-link">Hint 3</Link></li>
                    
                        <li className="pt-2 text-lg font-bold flex items-center justify-start space-x-1"><FaChevronRight size={12}/><Link href="#solution" className="text-link">Solution</Link></li>
                    
                        <li className="pt-2 text-lg font-bold flex items-center justify-start space-x-1"><FaChevronRight size={12}/><Link href="#cheese-solution" className="text-link">Cheese solution</Link></li>
