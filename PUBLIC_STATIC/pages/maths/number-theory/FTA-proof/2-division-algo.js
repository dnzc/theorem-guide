...
<h2 id="back-to-school" className="group flex">Back to School&nbsp;<Link href="#back-to-school" onClick={() => copyToClipboard("https://blog.danielc.rocks/maths/number-theory/FTA-proof/2-division-algo#back-to-school", true)} className="hidden group-hover:block text-primary">¶</Link></h2>
