...
<h2 id="existence-of-a-prime-factorization" className="group flex">Existence of a prime factorization&nbsp;<Link href="#existence-of-a-prime-factorization" className="hidden group-hover:block text-primary">¶</Link></h2>
...
<h2 id="uniqueness" className="group flex">Uniqueness&nbsp;<Link href="#uniqueness" className="hidden group-hover:block text-primary">¶</Link></h2>
