        ...
        <nav className="hidden xl:flex w-[300px] xl:shrink-0 xl:justify-start h-100% min-h-screen border-l-2 border-elevated px-6 py-4">
            <div className="fixed">
                ...
                <ul className="text-elevated">
                        ...
                        <li className="pt-2 list-inside list-disc"><Link href="#what-its-argh" className="text-primary"><em>What? It's... argh!</em></Link></li>
                    
                        <li className="pt-2 list-inside list-disc"><Link href="#the-actual-euclids-lemma" className="text-primary">The actual Euclid's Lemma</Link></li>
