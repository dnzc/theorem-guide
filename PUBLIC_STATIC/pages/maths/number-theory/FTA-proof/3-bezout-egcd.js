...
<h2 id="puzzle-water-jug-problem" className="group flex">Puzzle: water-jug problem&nbsp;<Link href="#puzzle-water-jug-problem" className="hidden group-hover:block text-primary">¶</Link></h2>
...
<h2 id="numerical-evidence" className="group flex">Numerical Evidence&nbsp;<Link href="#numerical-evidence" className="hidden group-hover:block text-primary">¶</Link></h2>
...
<h2 id="bezouts-lemma-proof" className="group flex">Bezout's Lemma: Proof&nbsp;<Link href="#bezouts-lemma-proof" className="hidden group-hover:block text-primary">¶</Link></h2>
...
<h2 id="magic-box" className="group flex">Magic box&nbsp;<Link href="#magic-box" className="hidden group-hover:block text-primary">¶</Link></h2>
...
<h2 id="remarks-first-unobvious-result" className="group flex">Remarks: first unobvious result?&nbsp;<Link href="#remarks-first-unobvious-result" className="hidden group-hover:block text-primary">¶</Link></h2>
