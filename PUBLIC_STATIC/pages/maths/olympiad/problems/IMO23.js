...
export default function IMO23 () {
    return (
        <Layout>
            <Head>
                <title>IMO23 | Daniel C</title>
            </Head>
        ...
        <ul>
            <li>
                ...
                <ul>
                            ...
                            <Accordion title="problems" href="/maths/olympiad/problems" isFolder={true} isSelected={ false } isOpenByDefault={ true } >
                                
                                    
                        
                            <Accordion title="IMO23" href="/maths/olympiad/problems/IMO23" isFolder={false} isSelected={ true } />
