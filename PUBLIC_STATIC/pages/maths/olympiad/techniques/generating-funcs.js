...
export default function GeneratingFuncs () {
        ...
        <ul>
            <li>
                ...
                <ul>
                            ...
                            <Accordion title="generating-funcs" href="/maths/olympiad/techniques/generating-funcs" isFolder={false} isSelected={ true } />
    ...
    <article className="w-full min-w-0 max-w-6xl px-6 pt-3">
        ...
        <div className="article mb-4">
            <h1 id="generating-functions-connecting-algebra-and-combinatorics">Generating Functions - Connecting Algebra and Combinatorics</h1>
