...
HERO = {
    'title': 'Mathematical insights, beautifully explained',
    'subtitle': 'Read colourful, interactive explanations of various mathematical topics - hopefully I can give you special insight.',
    'cta_text': 'Take me somewhere random',
    'cta_type': 'random'  # 'random' or 'link'
}
...
FAQ = [
    ...
    },
    {
        ...
        'answer': '''After my fair share of maths notes online, I realized that everything's written in LaTeX. Booo, boring! I like <em>colours</em> and <em>diagrams!</em> If you hate interactive, thoughtful content, this is not the website for you :)'''
    },
    {
    ...
    },
    {
        ...
        'answer': f'''You're thinking of your other favourite website, <DiscreetLink href="https://tripos.guru">tripos.guru</DiscreetLink>! I generate both sites using the same code <ProminentLink href="https://github.com/dnzc/notes">[github]</ProminentLink>. This leads to consistent, maths-first styling across both sites.'''
    }
]