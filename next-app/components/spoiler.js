    ...
    return (
        <blockquote>
            <div className="absolute">
                <button onClick={show} className={`relative top-2 p-1 text-Spoiler-accent hover:bg-button border-2 border-Spoiler-accent rounded-lg flex items-center space-x-0.5${visible ? ' hidden' : ''}`}>
