  ...
  >
    ...
    <path
      ...
      style={{
        ...
        strokeDashoffset: 0,
        strokeOpacity: 1,
        markerStart: "url(#workflow_svg__a)",
        markerEnd: "url(#workflow_svg__b)",
      }}
      transform="translate(-7.462 -5.837)"
    />
    <path
      d="M60.586 13.423v7.71"
      style={{
        fill: "var(--color-Svg-text)",
        stroke: "var(--color-Svg-text)",
        strokeWidth: 0.2,
    ...
    <text
      ...
      style={{
        ...
        fontVariantNumeric: "normal",
        fontVariantEastAsian: "normal",
        fill: "var(--color-Svg-text-highlight)",
        stroke: "var(--color-Svg-text)",
        strokeWidth: 0.2,
        strokeLinecap: "round",
        strokeLinejoin: "round",
