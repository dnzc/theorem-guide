...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="pseudocode" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Pseudocode</h2><Pilcrow href="#pseudocode" text="https://tripos.guru/comp-sci/binary-search#pseudocode"/></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="example-problem-minimum-excludant" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Example problem: Minimum excludant</h2><Pilcrow href="#example-problem-minimum-excludant" text="https://tripos.guru/comp-sci/binary-search#example-problem-minimum-excludant"/></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="harder-problem-ntarsis-set" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Harder problem: Ntarsis' Set</h2><Pilcrow href="#harder-problem-ntarsis-set" text="https://tripos.guru/comp-sci/binary-search#harder-problem-ntarsis-set"/></div>
