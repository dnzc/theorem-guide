import SvgCubetilings1 from '@/components/AUTOSVG/cubetilings/svgCubetilings1'
import SvgCubetilings2 from '@/components/AUTOSVG/cubetilings/svgCubetilings2'
import SvgCubetilings3 from '@/components/AUTOSVG/cubetilings/svgCubetilings3'
import SvgCubetilings4 from '@/components/AUTOSVG/cubetilings/svgCubetilings4'
import SvgCubetilings5 from '@/components/AUTOSVG/cubetilings/svgCubetilings5'
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="getting-a-foothold" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Getting a foothold</h2><Pilcrow href="#getting-a-foothold" text="https://tripos.guru/maths/research/cube-tilings#getting-a-foothold"/></div>
...
<p><SvgCubetilings1 width={ 320 } height={ 240 }/></p>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="construction-tools" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Construction Tools</h2><Pilcrow href="#construction-tools" text="https://tripos.guru/maths/research/cube-tilings#construction-tools"/></div>
...
<p><SvgCubetilings2 width={ 280 } height={ 300 }/></p>
...
<p><SvgCubetilings3 width={ 240 } height={ 300 }/></p>
...
<p><SvgCubetilings4 width={ 288 } height={ 400 }/></p>
...
<p><SvgCubetilings5 width={ 300 } height={ 300 }/></p>

</Proof>

</Thm>

<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="finding-a-base-case" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Finding a base case</h2><Pilcrow href="#finding-a-base-case" text="https://tripos.guru/maths/research/cube-tilings#finding-a-base-case"/></div>
...
<p><SvgCubetilings6 width={ 200 } height={ 200 }/></p>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="reducing-the-bound-with-code" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Reducing the bound with code</h2><Pilcrow href="#reducing-the-bound-with-code" text="https://tripos.guru/maths/research/cube-tilings#reducing-the-bound-with-code"/></div>
...
<p><SvgCubetilings7 width={ 480 } height={ 640 }/></p>
