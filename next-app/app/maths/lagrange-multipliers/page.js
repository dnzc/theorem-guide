...
<p><Latex>$U \subseteq \mathbb&#123;R&#125;^n$</Latex> is <strong>open</strong> if for every <Latex>$p \in U$</Latex>, <Latex>$\exists r\gt 0$</Latex> s.t. <Latex>$B(p,r) \subset U$</Latex>.</p>
...
<p>The sequence <strong>converges</strong> to the point <Latex>$x_\infty$</Latex> if <Latex>$\forall \epsilon \gt 0, \exists n_0 \in \mathbb&#123;N&#125;$</Latex> such that:</p>
...
<p>Let <Latex>$S \subseteq \mathbb&#123;R&#125;^n$</Latex>. <Latex>$S$</Latex> is <strong>closed</strong> if for every sequence of points <Latex>$(x_k)_&#123;k=1&#125;^\infty$</Latex> that satisfies <Latex>$x_k \in S \;\forall\; k$</Latex>, we have <Latex>$\left( \lim_&#123;k \to \infty&#125; x_k \right) \in S$</Latex>.</p>
...
<p><Latex>$A \subseteq \mathbb&#123;R&#125;^n$</Latex> is <strong>bounded</strong> if <Latex>$\exists\, R \in \mathbb&#123;R&#125;, R\gt 0$</Latex> such that <Latex>$A \subseteq B(0, R)$</Latex>.</p>
...
<p><Latex>$f$</Latex> is <strong>continuous at the point</strong> <Latex>$p \in D$</Latex> if <Latex>$\forall \epsilon \gt 0$</Latex>, <Latex>$\exists \delta \gt 0$</Latex> such that <Latex>$\forall x \in D$</Latex> we have:</p>
...
<p><Latex>$f$</Latex> is <strong>continuous</strong> if it is continuous at every point.</p>
...
<pre><code>&lt;AUTOSVG&nbsp;src='lagrange-mult/11-closedBall.svg'&nbsp;width='200'&nbsp;height='200'/&gt;<br/></code></pre>

</div>

</Example>

Note: We need to assume <Latex>$K$</Latex> is closed for this theorem, else we can construct a counterexample where <Latex>$f$</Latex> increases to infinity the closer you get to the edge.

<Thm type="Fact">

Let <Latex>$g : \mathbb&#123;R&#125;^n \to \mathbb&#123;R&#125;$</Latex> be continuous. Then for a fixed <Latex>$c \in \mathbb&#123;R&#125;$</Latex>, the set
...
is closed in <Latex>$\mathbb&#123;R&#125;^n$</Latex>.
...
<p><li><Latex>$f : \mathbb&#123;R&#125;^3 \to \mathbb&#123;R&#125;, f(x,y,z) = x^2 + y^2 + z^2$</Latex></li></p>
...
<p><li><Latex>$f : (0, +\infty) \times (0, +\infty) \to \mathbb&#123;R&#125;, f(x,y) = \sqrt&#123;xy&#125;$</Latex>.</li></p>
...
Let <Latex>$U \subset \mathbb&#123;R&#125;^n$</Latex> be an open set[^4] and let <Latex>$f,g : U \to \mathbb&#123;R&#125;$</Latex> be continuous functions with continuous partial derivatives of the first order.

Let <Latex>$c \in \mathbb&#123;R&#125;$</Latex> and <Latex>$S = \&#123;x \in U \mid g(x) = c\&#125;$</Latex>. (Note: <Latex>$S$</Latex> doesn't have to be open or closed, that's <Latex>$U$</Latex>!)

Then, if <Latex>$x_0 \in S$</Latex> is a local max or min, then either:
...
<p><p>Let <Latex>$x,y,z \geq 0$</Latex> such that <Latex>$x+y+z = 1$</Latex>. Find the min and max of <Latex>$xyz$</Latex>.</p></p>
...
Let <Latex>$f(x,y,z) = xyz$</Latex> and <Latex>$g(x,y,z)=x+y+z$</Latex>; these are polynomial functions and so are continuous. We are maximizing and minimizing <Latex>$f$</Latex>, subject to a condition on <Latex>$g$</Latex>.

<Latex>$0 \leq x,y,z \leq 1$</Latex> so we're only interested in the cube <Latex>$[0,1] \times [0,1] \times [0,1]$</Latex>.
...
Let <Latex>$U = (0,1)^3$</Latex>, then <Latex>$\bar U = [0,1]^3$</Latex>.

Let <Latex>$S = \&#123;x \in U \mid g(x)=1\&#125;$</Latex>, then <Latex>$\bar S$</Latex> is bounded hence compact.

Hence <Latex>$f$</Latex> has a global max and min in <Latex>$\bar S$</Latex>.

The global extrema might be on the boundary of <Latex>$\bar S$</Latex>. If so then we cannot apply LM, because the extrema will not be in <Latex>$S$</Latex>.

<ul>

<p><li><p>If we are on the boundary, then one of <Latex>$x,y,z$</Latex> is <Latex>$0$</Latex>, so <Latex>$f(x,y,z) = xyz = 0$</Latex>. Thus <Latex>$f$</Latex> is zero everywhere on the boundary, so <Latex>$0$</Latex> would be an extremum.</p></li>
<li><p>If we are not on the boundary, then we are in <Latex>$S$</Latex>, so we can apply LM.</p></li></p>
...
So <Latex>$yz = \lambda \cdot 1$</Latex>, <Latex>$xz = \lambda \cdot 1$</Latex>, <Latex>$xy = \lambda \cdot 1$</Latex>.  
This implies <Latex>$xy = yz = zx$</Latex> so <Latex>$x=y=z$</Latex>, and finally <Latex>$x+y+z = 1$</Latex> <Latex>$\implies$</Latex> <Latex>$x=y=z=\frac&#123;1&#125;&#123;3&#125;$</Latex>, so an extremal value of <Latex>$f$</Latex> is <Latex>$\frac&#123;1&#125;&#123;27&#125;$</Latex>.

Overall, all extreme values of <Latex>$f$</Latex> on <Latex>$\bar S$</Latex> are <Latex>$0$</Latex> or <Latex>$\frac&#123;1&#125;&#123;27&#125;$</Latex>.
...
<p><p>Let <Latex>$x,y,z \geq 0$</Latex> such that <Latex>$x+y+z = 1$</Latex>. Show that
  <span className="scrollshadow-horizontal-blockquote latex-display-wrapper"><Latex>$$0 \leq yz+zx+xy-2xyz \leq \frac&#123;7&#125;&#123;27&#125;$$</Latex></span></p></p>
...
Note <Latex>$0 \leq x,y,z \leq 1$</Latex>.

Let <Latex>$U = (0,1)^3$</Latex> and <Latex>$S = \&#123; x \in U \mid g(x) = 1\&#125;$</Latex>.

Let <Latex>$f(x,y,z) = yz+zx+xy-2xyz$</Latex> and <Latex>$g(x,y,z) = x+y+z$</Latex>, where <Latex>$f,g : U \to \mathbb&#123;R&#125;$</Latex>. Then <Latex>$f,g$</Latex> are continuous and have continous partial derivatives (because polynomial on open set).

Now, <Latex>$\bar U = [0,1]^3$</Latex> and <Latex>$\bar S = \bar U \cap \&#123;x \in \mathbb&#123;R&#125;^3 \mid g(x)=1\&#125;$</Latex> which is closed and bounded hence compact.

Hence <Latex>$f$</Latex> has a global max and min on <Latex>$\bar S$</Latex>.

Let <Latex>$x_0 = (x,y,z)$</Latex> be a global extremum.

<ul>

<p><li>If <Latex>$x_0$</Latex> is on the boundary:<br />
...
<p>We can apply LM, because there is no boundary case to check<sup className="footnote-ref" id="fnref-5"><a href="#fn-5">4</a></sup>.</p>
