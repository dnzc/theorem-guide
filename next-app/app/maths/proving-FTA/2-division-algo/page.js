...
export const metadata = {title:"2 Division Algo"}
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="back-to-school" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Back to School</h2><Pilcrow href="#back-to-school" text="https://tripos.guru/maths/proving-FTA/2-division-algo#back-to-school"/></div>
