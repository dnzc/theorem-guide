...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="what-its-argh" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">What? It's... argh!</h2><Pilcrow href="#what-its-argh" text="https://tripos.guru/maths/proving-FTA/4-euclid#what-its-argh"/></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="the-actual-euclids-lemma" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">The actual Euclid's Lemma</h2><Pilcrow href="#the-actual-euclids-lemma" text="https://tripos.guru/maths/proving-FTA/4-euclid#the-actual-euclids-lemma"/></div>
