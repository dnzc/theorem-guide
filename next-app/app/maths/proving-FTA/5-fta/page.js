...
export const metadata = {title:"5 Fta"}
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="existence-of-a-prime-factorization" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Existence of a prime factorization</h2><Pilcrow href="#existence-of-a-prime-factorization" text="https://tripos.guru/maths/proving-FTA/5-fta#existence-of-a-prime-factorization"/></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="uniqueness" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Uniqueness</h2><Pilcrow href="#uniqueness" text="https://tripos.guru/maths/proving-FTA/5-fta#uniqueness"/></div>
