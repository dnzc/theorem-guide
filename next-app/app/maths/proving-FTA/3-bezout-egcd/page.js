...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="puzzle-water-jug-problem" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Puzzle: water-jug problem</h2><Pilcrow href="#puzzle-water-jug-problem" text="https://tripos.guru/maths/proving-FTA/3-bezout-egcd#puzzle-water-jug-problem"/></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="numerical-evidence" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Numerical Evidence</h2><Pilcrow href="#numerical-evidence" text="https://tripos.guru/maths/proving-FTA/3-bezout-egcd#numerical-evidence"/></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="bezouts-lemma-proof" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Bezout's Lemma: Proof</h2><Pilcrow href="#bezouts-lemma-proof" text="https://tripos.guru/maths/proving-FTA/3-bezout-egcd#bezouts-lemma-proof"/></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="magic-box" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Magic box</h2><Pilcrow href="#magic-box" text="https://tripos.guru/maths/proving-FTA/3-bezout-egcd#magic-box"/></div>
...
<div className="text-2xl font-bold group flex space-x-1 pt-6 pb-2 items-baseline"><h2 id="remarks-first-unobvious-result" className="scroll-m-[calc(2.25rem+2*1rem+0.5rem)] md:scroll-m-[0.5rem] text-articleh2">Remarks: first unobvious result?</h2><Pilcrow href="#remarks-first-unobvious-result" text="https://tripos.guru/maths/proving-FTA/3-bezout-egcd#remarks-first-unobvious-result"/></div>
